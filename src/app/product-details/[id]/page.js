                ...
                return (
                  <div
                    className={`p-1 rounded col-3 ${
                      mainImage === v ? " border border-2 border-danger" : ""
                    }`}
                  >
                    <img
                      src={v}
                ...
                {cartList?.find((item) => item._id === details?._id) ? (
                  ...
                  >
                    ...
                    >
                      <p
                        onClick={(e) => handleDecreaseQty(e, details)}
                        className="mb-0 bg-danger p-2 d-flex justify-content-center align-items-center"
                        style={{
                          borderRadius: "50%",
                          width: "25px",
                          height: "25px",
                    ...
                    >
                      <p
                        onClick={(e) => handleIncreaseQty(e, details)}
                        className="mb-0 bg-danger p-1 d-flex justify-content-center align-items-center"
                        style={{
                          borderRadius: "50%",
                          width: "25px",
                          height: "25px",
