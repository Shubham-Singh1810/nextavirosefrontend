          ...
          <div className="col-md-6 col-12 row px-md-2 px-0">
            ...
            <div className="col-md-12 col-12 row my-auto">
              {details?.productGallery?.map((v, i) => {
                return (
                  <div className={`p-1 rounded col-3 ${ mainImage === v ? " border border-2 border-danger" : ""}`}>
                    <img
                      src={v}
              ...
              <div className="d-flex justify-content-between mt-md-3 mt-1 gap-3 align-items-center productDetailsBtn col-sm-10 col-12 p-0">
                {comboCartList?.find((item) => item._id === details?._id) ? (
                  <div
                    ...
                    style={{ borderRadius: "5px", height: "41px" ,  backgroundColor: "rgb(251 228 228)" ,border: "1px solid #ffdada"}}
                  >
                   <div  className="w-100 text-white mb-0 d-flex justify-content-center align-items-center" 
                    style={{ height: "100%" }}>
                     <p onClick={(e) => handleDecreaseQty(e, details)} className="mb-0 bg-danger p-2 d-flex justify-content-center align-items-center" 
                   ...
                   <div  className="w-100 text-white mb-0 d-flex justify-content-center align-items-center "
                      style={{ height: "100%" }}>
                     <p onClick={(e) => handleIncreaseQty(e, details)}  className="mb-0 bg-danger p-1 d-flex justify-content-center align-items-center" 
                     style={{borderRadius:"50%" , width:"25px" , height:"25px" , cursor:"pointer"}}>
                      +
                    </p>
                   </div>
                  ...
                  <button
                    ...
                    className="w-100 bg-danger rounded-pill"
                     style={{cursor:"pointer"}}
                  >
                    Add To Cart
                  </button>
